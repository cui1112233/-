...
- Task 1、2、3、4、6、7 的代码、测试和提交已完成；Task 8 的本地测试、隔离候选构建、交接与 Obsidian 记录已完成。
- Task 5 的真实 121 视频上传契约尚未在仓库或候选环境中得到证据，因此 `publish.121` 按设计保持不可用，没有猜测接口字段。
- Task 8 的真实供应商/登录/视频/121 回执验收和公网切换尚未完成；公网页面当前仍是旧 bundle，不能写成已发布。
- 具体证据与下一步见 `docs/superpowers/handoffs/2026-09-06-unified-batch-workbench-handoff.md`。
