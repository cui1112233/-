...
function seedSystemPresets(store, actor) {
  for (const preset of SYSTEM_PRESETS) {
    ...
    let upgradedBody = String(current.body || '').trim();
    ...
    const nextDescription = (renameQuickDirector || renameBatchStoryboardMeta || replaceLegacySmartUnifiedBody || replaceLegacyH3AssetBody)
      ? preset.description
      : current.description;
