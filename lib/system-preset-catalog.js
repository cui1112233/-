...
const BATCH_PRESETS = [
  ...
  ['batch-prop-meta', '道具提示词元提示词', '批量工厂关键道具与道具提示词规则', '批量工厂-道具提示词.md', { format: 'json', operation: 'prop-meta' }],
	...
	['batch-video-v11-director', 'V11导演提示词', '使用 H3 逐行导演卡和真实配音时间线，输出中文 VIDEO 提示词', '批量工厂-V11导演提示词.md', { format: 'json', operation: 'video-meta', key: 'v11-director-normal' }],
...
const SLOT_BY_PRESET_ID = Object.freeze({
  ...
  'batch-video-meta': 'batch.video-meta',
	...
	'batch-video-v11-director': 'batch.video-meta',
