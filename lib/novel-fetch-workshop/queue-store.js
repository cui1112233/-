...
function normalizeQueue(value) {
  ...
  return {
    ...
    activeItemId: String(source.activeItemId || ''),
    currentStage: String(source.currentStage || ''),
    lastEvent: source.lastEvent && typeof source.lastEvent === 'object' ? source.lastEvent : null,
