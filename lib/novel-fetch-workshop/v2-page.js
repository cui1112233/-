...
const CLIENT_TAG = `<script src="${CLIENT_PATH}?v=20260901-source-aligned-r2"></script>`;
const DATE_CLIENT_TAG = `<script src="${DATE_CLIENT_PATH}?v=20260901-source-aligned-r2"></script>`;
const CONFIG_CLIENT_TAG = `<script src="${CONFIG_CLIENT_PATH}?v=20260901-source-aligned-r2"></script>`;
...
module.exports = { CLIENT_PATH, DATE_CLIENT_PATH, CONFIG_CLIENT_PATH, injectNovelFetchV2Script, createNovelFetchV2PageMiddleware };
