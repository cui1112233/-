...
const CLIENT_TAG = `<script src="${CLIENT_PATH}?v=20260916-performance-r1"></script>`;
const DATE_CLIENT_TAG = `<script src="${DATE_CLIENT_PATH}?v=20260916-performance-r1"></script>`;
const CONFIG_CLIENT_TAG = `<script src="${CONFIG_CLIENT_PATH}?v=20260916-performance-r1"></script>`;
const LAYOUT_CLIENT_TAG = `<script src="${LAYOUT_CLIENT_PATH}?v=20260917-submit-activation-r1"></script>`;
const RUN_CONTROLS_CLIENT_TAG = `<script src="${RUN_CONTROLS_CLIENT_PATH}?v=20260916-performance-r1"></script>`;
