...
const LAYOUT_CLIENT_TAG = `<script src="${LAYOUT_CLIENT_PATH}?v=20260901-image-layout-r1"></script>`;
...
module.exports = { CLIENT_PATH, DATE_CLIENT_PATH, CONFIG_CLIENT_PATH, LAYOUT_CLIENT_PATH, injectNovelFetchV2Script, createNovelFetchV2PageMiddleware };