...
const APP_CLIENT_TAG = `<script src="${APP_PATH}?v=20260922-real-date-filter-r1"></script>`;
...
const CLIENT_TAG = `<script src="${CLIENT_PATH}?v=20260917-selection-sync-r1"></script>`;
