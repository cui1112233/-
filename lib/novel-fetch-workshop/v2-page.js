...
const CLIENT_TAG = `<script src="${CLIENT_PATH}?v=20260901-source-aligned-r1"></script>`;
const CONFIG_CLIENT_TAG = `<script src="${CONFIG_CLIENT_PATH}?v=20260901-source-aligned-r1"></script>`;
