...
function attachV78NovelFetchV2({
  ...
  const browserClientFactory = createBrowserClient || (
    process.env.QIANTIE_121_USE_BROWSER_WORKER === '1'
      ? require('./121-browser-worker-client').create121BrowserWorkerClient
      : require('./121-browser-client').create121BrowserClient
  );
