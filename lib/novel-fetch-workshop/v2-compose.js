...
function attachV78NovelFetchV2({
  ...
  const browserClientFactory = createBrowserClient || (
    process.env.QIANTIE_121_BROWSER_WORKER_URL && process.env.QIANTIE_121_WORKER_SECRET
  ...
  shellApp.use('/api/batch-rewrite', parser, routerFactory({ queue: runtime.queue, scheduler: runtime.scheduler, taskOps, batches, webSubmit }));
