...
function create121BrowserClient({
  ...
  async function request(path, { method = 'POST', body } = {}) {
    ...
    const timeout = Math.max(1000, Math.min(Number(timeoutMs) || DEFAULT_TIMEOUT_MS, 60000));
...
module.exports = { unavailableError, normalizeWorkerBaseUrl, create121BrowserClient, DEFAULT_TIMEOUT_MS };
