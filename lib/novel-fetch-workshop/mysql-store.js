...
const META_DEFAULTS = {
  bookId: '', bookName: '', paidBookId: '', freeBookId: '', platformId: '', platformName: '', gender: '', genderSource: '', style: '', styleSource: '', tags: '', reason: '', rating: '', sourceLine: '', parseMode: '', parseColumns: [], maxTxt: 4000, aiCount: 1, classifyStatus: '', classifyError: '', classifyConfidence: null, classifyReason: '', classifierModel: '', retryStage: '', status: 'created', originalStatus: '', originalChars: 0, originalRawChars: 0, originalFetchAttempts: 0, originalErrorCode: '', originalUpstreamCode: null, originalErrorMessage: '', sensitiveStatus: '', sensitiveHitCount: 0, sensitiveFixedCount: 0, sensitiveFailedCount: 0, aiStatus: '', aiGeneratedCount: 0, aiError: '', siteSubmitStatus: '', siteSubmitError: '', siteSubmitDoneVersions: [], siteSubmitAcceptedVersions: [], siteSubmitFailedVersions: [], error: '', createdAt: '', updatedAt: ''
};
