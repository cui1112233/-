...
function createMySQLWorkshopStore({ targetBaseUrl, bridgeSecret, account, fetchUpstream } = {}) {
  ...
  return {
    ...
    getStyles: () => STYLES,
    saveTasks, listTasks, getTask, updateTaskMeta, fetchOriginal, readOriginal, saveOriginalText, restoreOriginal, readLogs, readVersionText, saveVersionText, appendLog, appendSiteSubmitLog, readSiteSubmitLog, readSiteSubmitResult, deleteTasks, writeRunAudit
  };
}
