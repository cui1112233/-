...
function resolveModelAccess({ memberStore, username, kind, modelId, configReader = readConfig } = {}) {
  return resolveRuntimeModel({ username, kind, modelId, memberStore, configReader });
}
