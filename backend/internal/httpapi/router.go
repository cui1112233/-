...
func (api *API) Router() http.Handler {
	...
	r.Route("/api", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Get("/shuihuo-production/user/video-model-credentials", api.handleGetShuihuoVideoModelCredentials)
			r.Put("/shuihuo-production/user/video-model-credentials", api.handleSaveShuihuoVideoModelCredentials)
			r.Delete("/shuihuo-production/user/video-model-credentials", api.handleDeleteShuihuoVideoModelCredentials)
