...
type Config struct {
	...
	MergeTOSEndpoint              string
	MergeTOSRegion                string
	MergeTOSBucket                string
	MergeTOSAccessKey             string
	MergeTOSSecretKey             string
	MergeTOSPublicBaseURL         string
