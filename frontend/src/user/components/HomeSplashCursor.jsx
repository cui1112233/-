...
function HomeSplashCursor({
  ...
  BACK_COLOR = { r: 0.03, g: 0.02, b: 0.08 },
  TRANSPARENT = true,
  RAINBOW_MODE = false,
  COLOR = '#c084fc'
}) {
  ...
  useEffect(() => {
    ...
    if (!canvas || prefersReducedMotion || usesTouch) return;
    ...
    function handleMouseDown(e) {
      ...
      const { x: posX, y: posY } = getCanvasPoint(e);
  ...
  return (
    <div className="home-splash-cursor" style={{ pointerEvents: 'none' }} aria-hidden="true">
      <canvas
        ref={canvasRef}
        className="home-splash-cursor-canvas"
      />
    </div>
  );
}

export default HomeSplashCursor;
