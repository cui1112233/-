...
import { createBatchFactoryBatch, getBatchFactoryBatch, listBatchFactoryBatches, startBatchFactoryBatch } from '../../shared/api/batchFactory';
...
export function BatchFactoryPreviewPage() {
  const [batch, setBatch] = useState(null); const [selectedId, setSelectedId] = useState(''); const [currentFilter, setCurrentFilter] = useState('全部'); const [filterPosition, setFilterPosition] = useState(0); const [intakeOpen, setIntakeOpen] = useState(false); const [starting, setStarting] = useState(false); const listRef = useRef(null);
