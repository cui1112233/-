...
function createScriptVideoRouter({ configReader = readConfig, submit = defaultSubmit, request = upstreamRequest, h3Submit = defaultH3Submit, h3Request = defaultH3Request, h3ApiKeyReader = h3ApiKeyFromEnvironment, authenticate = apiAuth, shuihuoGateway, memberStore } = {}) {
...
module.exports = { createScriptVideoRouter, DEFAULT_FIRST_FRAME_URL, h3ApiKeyFromEnvironment, h3Duration, h3Resolution, publicH3TaskID, validH3ReferenceImageURLs, validOptionalImageURLs, readTaskID, taskState, resultURL };
